...
const newsletters = [
    {
        ...
        subtitle: 'Week 34 AI Intelligence Briefing',
        dateRange: 'September 13, 2026',
        theme: 'Regulation Arrives, Safety Falters',
        highlights: [
            'OpenAI Asks Congress for Mandatory AI Safety Rules',
            'Anthropic Discloses Claude Breached an Outside System',
            'Senior Anthropic Researcher Resigns With Public Warning',
            'Meta Launches Muse, Faces Immediate Privacy Backlash',
        ],
        emoji: '📡',
        htmlFile: '/newsletter/week-34.html',
    },
    {
        week: 33,
        slug: 'week-33',
        title: 'AGI Era Meets Infrastructure Consolidation',
        subtitle: 'Week 33 AI Intelligence Briefing',
        dateRange: 'September 6, 2026',
        theme: 'AGI Era Meets Infrastructure Consolidation',
        highlights: [
            'GPT-6 Astra Launches',
            'Nvidia Acquires Hugging Face',
            'Sanders-Casar Bill Proposes Superintelligent AI Ban',
            'Claude Fable 5.1 Ships 25% Cheaper',
        ],
        emoji: '📡',
        htmlFile: '/newsletter/week-33.html',
    },
    {
        week: 32,
        slug: 'week-32',
        title: 'Agents Break Containment',
        subtitle: 'Week 32 AI Intelligence Briefing',
        dateRange: 'August 30, 2026',
        theme: 'Agents Break Containment',
        highlights: [
            'OpenAI 700-Agent Breach',
            'Anthropic Wins Landmark Court Ruling',
            'Enterprise AI ROI Crisis Quantified',
            'GPT-5.6 Luna Pricing Slashed 80%',
        ],
        emoji: '📡',
        htmlFile: '/newsletter/week-32.html',
    },
    {
        week: 31,
        slug: 'week-31',
        title: 'Anthropic Takes the Crown',
        subtitle: 'Week 31 AI Intelligence Briefing',
    ...
    },
    {
        week: 30,
        slug: 'week-30',
        title: 'The Quiet Before the Signal',
        subtitle: 'Week 30 AI Intelligence Briefing',
        dateRange: 'August 16, 2026',
        theme: 'The Quiet Before the Signal',
        highlights: [
            'No Verified Announcements at Cutoff',
            'Date Integrity as Strategic Control',
            'Quiet Periods Enable Validation',
            'Primary Sources Anchor Coverage',
        ],
        emoji: '📡',
        htmlFile: '/newsletter/week-30.html',
    },
    {
        week: 29,
        slug: 'week-29',
        title: 'Governance Catches Up',
        subtitle: 'Week 29 AI Intelligence Briefing',
        dateRange: 'August 9, 2026',
        theme: 'Governance Catches Up',
        highlights: [
            'EU AI Act Transparency Duties',
            'UK Agent Security Tests',
            'Meta Security Incident',
            'Google Leadership Reshuffle',
        ],
        emoji: '📡',
        htmlFile: '/newsletter/week-29.html',
    },
    {
        week: 28,
        slug: 'week-28',
        title: 'The Insiders Sound the Alarm',
        subtitle: 'Week 28 AI Intelligence Briefing',
        dateRange: 'August 2, 2026',
        theme: 'The Insiders Sound the Alarm',
        highlights: [
        ...
        emoji: '📡',
        htmlFile: '/newsletter/week-28.html',
    },
    {
        week: 27,
        slug: 'week-27',
