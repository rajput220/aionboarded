...
export function Footer() {
    ...
    return (
        <footer style={{ background: 'var(--bg-secondary)', borderColor: 'var(--border-color)' }} className="border-t mt-auto">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <p className="text-sm leading-relaxed mb-4" style={{ color: 'var(--text-secondary)' }}>
                            Creating awareness and sharing knowledge on AI tools and latest AI developments. Join 100+ members in our growing community.
                        </p>
                        {/* Social Links */}
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            {[
                                ...
                                <li key={link.href}>
                                    <Link href={link.href} className="text-sm transition-colors hover:text-[var(--color-brand-500)]" style={{ color: 'var(--text-secondary)' }}>
                                        {link.label}
                                    </Link>
                                </li>
                            ))}
                ...
                {/* Bottom */}
                <div className="mt-12 pt-8 border-t flex flex-col sm:flex-row justify-between items-center gap-4" style={{ borderColor: 'var(--border-color)' }}>
