/**
 * AIOnboarded - Newsletter Campaign Sender (Week 9)
 * 
 * Theme: The Agentic Era: AI Colleagues, Rogue Agents & the Race to Regulate
 */
...
async function sendCampaign() {
  try {
    ...
    console.log('Preparing to send Week 9 Campaign...')
      ...
      const htmlBody = `
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 20px; color: #334155; line-height: 1.7;">
          ...
          <div style="text-align: center; margin: 40px 0;">
            <a href="${process.env.NEXT_PUBLIC_SITE_URL || 'https://aionboarded.ai'}/newsletter/week-9.html"
