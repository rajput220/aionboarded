 ...
 * Run inside the Docker container with: node scripts/send-campaign-week11-standalone.mjs
 * 
 * Theme: Claude Cowork Skills & Ecosystem Shift
 */
...
async function sendCampaign() {
  ...
  try {
    ...
    for (const sub of confirmedSubs) {
      ...
      const htmlBody = `
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 20px; color: #334155; line-height: 1.7;">
          <div style="text-align: center; margin-bottom: 32px;">
            ...
            <p style="color: #64748B; font-size: 14px; margin-top: 4px;">Week 12: Claude Cowork Skills & Ecosystem Shift</p>
          </div>

          <p style="font-size: 16px;">Hi ${firstName},</p>
          
          <p style="font-size: 16px; font-weight: 500; color: #0F172A;">Stop re-explaining yourself. Teach Claude your workflow once, use it forever.</p>
          
          <p style="font-size: 16px;">In this week's edition, we explore <strong>Claude Cowork Skills</strong> along with massive industry milestones. Highlights include:</p>
          
          <ul style="padding-left: 20px; font-size: 15px;">
            <li style="margin-bottom: 8px;"><strong>What is a Skill?</strong> Learn the anatomy of Frontmatter and Instructions to automate your tasks.</li>
            <li style="margin-bottom: 8px;"><strong>Skill Demo:</strong> Walkthrough of building a custom LinkedIn Post Skill from scratch.</li>
            <li style="margin-bottom: 8px;"><strong>OpenAI $122B Raise:</strong> Capital concentration at an unprecedented $852B valuation.</li>
            <li style="margin-bottom: 8px;"><strong>Google Gemma 4:</strong> The release of open-weight frontier-class multimodal models under Apache 2.0.</li>
            <li style="margin-bottom: 8px;"><strong>Anthropic Coefficient Bio:</strong> A massive acquisition pivoting heavily into high-stakes drug discovery.</li>
          </ul>

          <div style="text-align: center; margin: 40px 0;">
            <a href="${SITE_URL}/newsletter/week-11.html"
          ...
          <div style="background: #F8FAFC; border-radius: 16px; padding: 24px; margin: 32px 0; border: 1px solid #E2E8F0;">
            ...
            <p style="font-size: 14px; margin-bottom: 20px;">Connect with 150+ fellow AI enthusiasts and collaborate on custom Skills:</p>
      ...
      try {
        await resend.emails.send({
          ...
          to: email,
          subject: 'Claude Cowork Skills & Ecosystem Shift 🧠',
          html: htmlBody,
        })
        successCount++
    ...
    await client.end()
    console.log(`\nWeek 12 Campaign (week-11.html) Complete.`)
